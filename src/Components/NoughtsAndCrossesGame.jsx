...
class NoughtsAndCrossesGame extends Component {
    ...
    return (
      <div>
        <div className={styles.winnerMsg}>
          <h1>{this.checkResult(this.state.noWin)}</h1>
        </div>
        ...
        <div className={styles.gridContainer}>
          <ul className={styles.game}>
            <button
              ...
              id="UL"
              className={this.state.board["UL"] === "O" ? styles.nought : null}
            >
            ...
            <button
              ...
              id="UR"
              className={this.state.board["UR"] === "O" ? styles.nought : null}
            >
            ...
            <button
              ...
              id="ML"
              className={this.state.board["ML"] === "O" ? styles.nought : null}
            >
            ...
            <button
              ...
              id="MM"
              className={this.state.board["MM"] === "O" ? styles.nought : null}
            >
            ...
            <button
              ...
              id="MR"
              className={this.state.board["MR"] === "O" ? styles.nought : null}
            >
            ...
            <button
              ...
              id="BL"
              className={this.state.board["BL"] === "O" ? styles.nought : null}
            >
            ...
            <button
              ...
              id="BM"
              className={this.state.board["BM"] === "O" ? styles.nought : null}
            >
            ...
            <button
              ...
              id="BR"
              className={this.state.board["BR"] === "O" ? styles.nought : null}
            >
  ...
  componentDidUpdate() {
    if (
      ...
      this.checkResult() !== this.state.winTag1 &&
      this.checkResult() !== this.state.winTag2
    ) {
